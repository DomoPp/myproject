...
const MENUITEMS = [
  ...
  { state: 'lesson', type: 'link', name: 'Lesson', icon: 'import_contacts' },
  { state: 'three', type: 'link', name: 'three', icon: 'import_contacts' },
    { state: 'testsone', type: 'link', name: 'TestsOne', icon: 'import_contacts' },
